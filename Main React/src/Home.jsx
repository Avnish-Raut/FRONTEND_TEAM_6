            ...
            <div className = "row">
                <div className = "col-10 mx-auto">
                    ...
                    <div className="col-md-6 pt-5 pt-lg-5 order-2 order-lg-1">
                        <h1>
                            Nurture your Business with <strong className="brand-name">Merklebits</strong>
                        </h1>
                    <h3 className="my-2">
                        A Domain with Every Solution
                    </h3>
                    <div className="mt-5">
                        <a href=" " className="btn btn-outline-light custom_button">Get Started</a>
                    </div>
        </div>
            <div class="col-md">
            <img src= {main_image} className="img-fluid animated" alt="main_image" />
          </div>
...
<section id="second-section" className="d-flex align-items-center">
        ...
        <div className = "row">
        <div class="col-md">
            <img src= {sec_image} className="img-fluid second_main_image animated" alt="sec_image" />
          </div>
          <div class="col-md p-5">
            ...
            <p>
              Enhance your skills with us . Learn more about real life products
              and improve in the technical environment. Visit out website for
              more information.
            </p>
...
<section id="third-section" className="d-flex align-items-center">
        ...
        <div class="col-md p-5">
            <h2>Ecommerce</h2>
            <p className="lead">
              E-Mind . The website to have customers enjoy the feel of buying
            ...
            <p>
              ...
              the customer experience a little bit better. Have a look at our
              variety of products
            </p>
            <a href= " " className="btn btn-outline-light custom_button mt-3">
              <BsFillCaretRightFill/> Look More
            </a>
            </div>
        <div class="col-md">
        <img src = {third_image} className = "img-fluid animated" alt="third_image"/>
        </div>
...
<section id="fourth-section"  className="d-flex align-items-center" >
        ...
        <img src = {fourth_image} className="img- animated" alt="fourth_image"/>
        </div>
        <div className="col-md p-5">
         <h2>Software Development</h2>
            <p className="lead text-white">Where innovation meets excellence</p>
            <p className="text-white">
              Our company is dedicated to developing software products for our
              customers. To view our previously made software products click the
              button.
            </p>
            <a href=" " class="btn btn-outline-light custom_button mt-3">
...
<div class="container pt-5">
        ...
        <div class="accordion accordion-flush" id="questions">
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                ...
                Technology.<br />Mount Poinsur, S.V.P. Road, Borivali (West),
                Mumbai 400 103.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                We have our own ecommerce company,a software developing company
                ,a educational institution company and an import and export
                company.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            >
              <div class="accordion-body">
                ...
                welcome you to ask any question related to your project and also
                placements.
              </div>
            </div>
          </div>
...
An organizational structure is a system that outlines how certain activities are directed in order to achieve the goals of an organization.</p>
  ...
  <div className="card-body">
    ...
    <p className="card-text">A financial compensation that is above and beyond the normal payment expectations of its recipient.</p>
    <a href=" " className="btn btn-primary">Go somewhere</a>
  </div>
</div>
  ...
  <div className="card-body">
    ...
    <p className="card-text">
        A checklist is a list of all the things that you need to do, information that you want to find out, or things that you need to take somewhere.</p>
    <a href=" " className="btn btn-primary">Go somewhere</a>
  </div>
</div>
...
<div id="seventh-container" class="container main-footer">
  ...
  <h3 className="text-center main_heading+
  ">Contact-Us</h3>
  <hr/>
    <div class="row pt-5">
      <div class="col-2">
